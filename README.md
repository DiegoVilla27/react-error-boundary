...
How to use Error Boundary to show errors

- This project was generated with [Vite](https://vitejs.dev/guide/) version 5.4.0
```bash
...
npm run dev
```
for a dev server and navigate to `http://localhost:3000/`. The applirecation will automatically reload if you change any of the source files.
